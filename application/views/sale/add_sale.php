                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="first_name" value="<?php if (isset($sale_info)) echo $sale_info->first_name ?>" class="form-control">
                        </div>
                    </div>
<!--                    <div class="col-lg-6">
...
<script>
    jQ.push(function () {
        $('#submitProcess').click(function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo base_url() ?>sale/save_sale/<?php echo $edit ? $edit : '' ?>",
